...
namespace RS1_Ispit_asp.net_core.Migrations
{
    ...
    [Migration("20200206214118_inicijalna")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RS1_Ispit_asp.net_core.EntityModels.PopravniIspitDetalji", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<int>("PopravniIsppitId");

                    b.Property<int>("UcenikId");

                    b.Property<int>("bodoviIspita");

                    b.Property<bool>("imaPracoPristupa");

                    b.Property<bool>("isPristupio");

                    b.HasKey("Id");

                    b.HasIndex("PopravniIsppitId");

                    b.HasIndex("UcenikId");

                    b.ToTable("PopravniIspitDetalji");
                });

            modelBuilder.Entity("RS1_Ispit_asp.net_core.EntityModels.PopravniIsppit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("RS1_Ispit_asp.net_core.EntityModels.PopravniIspitDetalji", b =>
                {
                    b.HasOne("RS1_Ispit_asp.net_core.EntityModels.PopravniIsppit", "PopravniIsppit")
                        .WithMany()
                        .HasForeignKey("PopravniIsppitId")
                        .OnDelete(DeleteBehavior.Cascade);
