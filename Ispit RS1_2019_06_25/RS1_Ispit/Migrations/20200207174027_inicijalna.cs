        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ispit_AkademskaGodina_AkademskaGodinaId",
                        column: x => x.AkademskaGodinaId,
                        principalTable: "AkademskaGodina",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IspitDetlji", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IspitDetlji_Ispit_IspitId",
                        column: x => x.IspitId,
                        principalTable: "Ispit",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IspitDetlji_Student_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Student",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ispit_AkademskaGodinaId",
                table: "Ispit",
                column: "AkademskaGodinaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IspitDetlji_IspitId",
                table: "IspitDetlji",
                column: "IspitId");

            migrationBuilder.CreateIndex(
                name: "IX_IspitDetlji_StudentId",
                table: "IspitDetlji",
                column: "StudentId");
